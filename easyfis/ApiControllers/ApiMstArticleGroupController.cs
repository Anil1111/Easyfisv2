...
namespace easyfis.ModifiedApiControllers
{
    public class ApiMstArticleGroupController : ApiController
    {
        ...
        // =================================
        // Dropdown List - Account (OLD API)
        // =================================
        [Authorize, HttpGet, Route("api/articleGroup/account/list/{articleTypeId}")]
        ...
        // ===============================================
        // List Article Group By Article Type Id (OLD API)
        // ===============================================
        [Authorize, HttpGet, Route("api/listArticleGroupByArticleTypeId/{articleTypeId}")]
