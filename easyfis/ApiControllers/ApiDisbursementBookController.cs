...
{
    public class ApiDisbursementBookController : ApiController
    {
        // ============
        // Data Context
        // ============
        ...
        public List<Models.TrnJournal> ListDisbursementBook(String startDate, String endDate, String companyId, String branchId)
        {
