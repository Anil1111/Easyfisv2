...
{
    public class ApiRepReceivingReceiptBookController : ApiController
    {
        // ============
        // Data Context
        // ============
        ...
        // ================================
        [Authorize, HttpGet, Route("api/receivingReceiptBook/dropdown/list/company")]
        public List<Entities.MstCompany> DropdownListReceivingReceiptBookListCompany()
        {
        ...
        // ===============================
        [Authorize, HttpGet, Route("api/receivingReceiptBook/dropdown/list/branch/{companyId}")]
        public List<Entities.MstBranch> DropdownListReceivingReceiptBookListBranch(String companyId)
        {
