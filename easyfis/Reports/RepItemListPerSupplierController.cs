...
{
    public class RepItemListPerSupplierController : Controller
    {
        // ============
        // Data Context
        // ============
        ...
        // ===================================
        // Item List Per Supplier Report - PDF
        // ===================================
        [Authorize]
        public ActionResult ItemListPerSupplier(Int32 SupplierId)
        {
            // ==============================
            ...
            headerPage.AddCell(new PdfPCell(new Phrase("Item List Per Supplier", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
            ...
            var items = from d in db.MstArticles
                        where d.DefaultSupplierId == SupplierId
                        && d.ArticleTypeId == 1
                        select new
                        {
                            Id = d.Id,
            ...
            if (items.Any())
            {
                ...
                if (supplier.Any())
                {
                    ...
                    PdfPCell branchHeaderColspan = (new PdfPCell(new Phrase(supplier.FirstOrDefault().Article, fontArial12Bold)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 10f, PaddingBottom = 14f });
