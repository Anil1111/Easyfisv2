...
namespace easyfis.Reports
{
    public class RepBIRCASDisbursementBookController : Controller
    {
        ...
        public ActionResult BIRCASDisbursementBook(String StartDate, String EndDate, String CompanyId, String BranchId)
        {
            ...
            header.AddCell(new PdfPCell(new Phrase("Disbursement Book", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
            ...
            if (journals.Any())
            {
                ...
                foreach (var journal in journals)
                {
                    ...
                    data.AddCell(new PdfPCell(new Phrase("CV-" + journal.TrnDisbursement.CVNumber, fontArial11)) { HorizontalAlignment = 0, PaddingTop = 3f, PaddingBottom = 6f, PaddingLeft = 5f, PaddingRight = 5f });
