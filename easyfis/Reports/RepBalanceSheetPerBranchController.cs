...
{
    public class RepBalanceSheetPerBranchController : Controller
    {
        // ============
        // Data Context
        // ============
        ...
        public ActionResult BalanceSheetPerBranch(String DateAsOf, Int32 CompanyId, Int32 BranchId)
        {
            ...
            header.AddCell(new PdfPCell(new Phrase("Balance Sheet Per Branch", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
