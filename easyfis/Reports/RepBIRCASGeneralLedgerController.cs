...
{
    public class RepBIRCASGeneralLedgerController : Controller
    {
        // ============
        // Data Context
        // ============
        ...
        // =====================
        [Authorize]
        public ActionResult BIRCASGeneralLedger(String StartDate, String EndDate, String CompanyId, String BranchId)
        {
            // ==============================
