...
namespace easyfis.POSIntegrationApiControllers
{
    public class ApiPOSIntegrationTrnArticlePriceController : ApiController
    {
        ...
        public List<POSIntegrationEntities.POSIntegrationTrnArticlePrice> GetItemPricePOSIntegration(String branchCode, String IPDate)
        {
            var itemPrices = from d in db.TrnArticlePriceItems
                             ...
                             select new POSIntegrationEntities.POSIntegrationTrnArticlePrice
                             {
                                 ...
                                 Particulars = d.TrnArticlePrice.Particulars,
                                 ManualIPNumber = d.TrnArticlePrice.ManualIPNumber,
